...
function hitungGajiBersih($nama, $gajiPokok, $tinggalLuarKota, $jamLembur, $jumlahHariTidakMasuk) {
...
hitungGajiBersih($nama, $gajiPokok, $tinggalLuarKota, $jamLembur, $jumlahHariTidakMasuk);
