...
<body>
    ...
    <div class="product-section">
        ...
        <div class="product-card-container">
            ...
            // Periksa apakah brand dipilih, dan apakah ada produk dari brand tersebut
            if (isset($_GET['brand']) && array_key_exists($_GET['brand'], $products)) {
                $selectedBrand = htmlspecialchars($_GET['brand']);
                $selectedLaptops = $products[$selectedBrand];
                ...
                echo '<p>Pilih brand untuk melihat produk laptop.</p>';
            }
            ?>
        </div>
    </div>
